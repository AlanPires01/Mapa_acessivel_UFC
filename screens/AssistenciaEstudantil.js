  ...
  return (
    <ScrollView style={css.container}>
      ...
      <Text style={css.texto}>
        <Paragraph>         As ações de assistência estudantil são promovidas através da Pró-Reitoria de Assuntos Estudantis (PRAE) da UFC e buscam:  {'\n'}
      ...
      showMoradia ? (
      <Text style={css.texto}>
         <Paragraph>          O Programa Auxílio Moradia tem por objetivo viabilizar a permanência de estudantes matriculados nos Cursos de Graduação dos Campi da Universidade Federal do Ceará (UFC) em Sobral, Cariri e Quixadá, 
         ...
         {'\n'}
         <Paragraph>          Importante! A vinculação dos estudantes ao Programa Auxílio Moradia não os impede de receber, por mérito, qualquer uma das bolsas dos diversos programas da UFC, de agências de fomento ou de empresas.</Paragraph>
      </Text>
      ) : null
      ...
      showBia ? (
      <Text style={css.texto}>
         <Paragraph>          O Programa Bolsa de Iniciação Acadêmica tem por objetivo propiciar aos estudantes de Cursos de Graduação Presenciais da Universidade Federal do Ceará (UFC) – em situação de vulnerabilidade socioeconômica comprovada – 
      ...
      showEmergencial ? (
      <Text style={css.texto}>
          <Paragraph>         O auxílio emergencial tem como objetivo disponibilizar ajuda financeira, em caráter de eventualidade, a estudantes de graduação, em situação de vulnerabilidade socioeconômica comprovada
     ...
     <Divider style={{backgroundColor:'#016EA4', height: 10}} />
      ...
      showServSocial ? (
      <Text style={css.texto}>
        <Paragraph>         O Setor de Serviço Social do Campus de Sobral da Universidade Federal do Ceará (UFC) volta-se para o atendimento das demandas dos discentes, 
        com base na Política Nacional de Assistência Estudantil (PNAES, Decreto nº. 7.234/2010).
        </Paragraph>
        {'\n'}
        <Paragraph>         Além do trabalho direto com os auxílios oferecidos pela PRAE, o Serviço Social realiza orientações aos alunos do campus e encaminhamentos para a rede socioassistencial do município de Sobral e adjacências. 
